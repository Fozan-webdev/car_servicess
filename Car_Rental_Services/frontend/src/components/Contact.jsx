...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://wa.me/+923262913635?text=${whatsappMessage}`,
      "_blank",
    );
          ...
          <div className={styles.formCard}>
            ...
            <div className="mb-4">
              <h2 className={styles.formTitle}>
                <IoIosSend /> Send Us a Message
              </h2>
              <p className={styles.formSubtitle}>
                Have a question or want to book? Fill out the form and we'll get
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className=" relative">
                ...
                <textarea
                  ...
                  required
                  rows="3"
                  placeholder="Tell us about your re..."
